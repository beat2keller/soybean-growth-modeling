...
import sys
sys.path.append('/cluster/software/stacks/2024-05/python-cuda/3.11.6/lib/python3.11/site-packages')
import torch
...
with open("env_export.yml", "w") as f:
    yaml.dump(env, f)
...
for epoch in range(num_epochs):
    ...
    if avg_val_loss < best_val_loss:
        ...
        torch.save(model.state_dict(), "model_soybean_segmentation.pth")
        patience_counter = 0
